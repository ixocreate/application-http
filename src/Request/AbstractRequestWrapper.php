...
abstract class AbstractRequestWrapper implements ServerRequestInterface, RequestWrapperInterface
{
    /**
    ...
    {
        return $this->previousRequest->getProtocolVersion();
    }
    ...
    {
        return $this->previousRequest->getHeaders();
    }
    ...
    {
        return $this->previousRequest->hasHeader($name);
    }
    ...
    {
        return $this->previousRequest->getHeader($name);
    }
    ...
    {
        return $this->previousRequest->getHeaderLine($name);
    }
    ...
    {
        return $this->previousRequest->getBody();
    }
    ...
    {
        return $this->previousRequest->getRequestTarget();
    }
    ...
    {
        return $this->previousRequest->getMethod();
    }
    ...
    {
        return $this->previousRequest->getUri();
    }
    ...
    {
        return $this->previousRequest->getServerParams();
    }
    ...
    {
        return $this->previousRequest->getCookieParams();
    }
    ...
    {
        return $this->previousRequest->getQueryParams();
    }
    ...
    {
        return $this->previousRequest->getUploadedFiles();
    }
    ...
    {
        return $this->previousRequest->getParsedBody();
    }
    ...
    {
        return $this->previousRequest->getAttributes();
    }
    ...
    {
        return $this->previousRequest->getAttribute($name, $default);
    }
